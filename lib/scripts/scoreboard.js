...
Scoreboard.prototype.displayWinner = function() {
  ...
  this.context.fillText('Press `enter` to start a new game or', this.canvas.width / 2, 450);
  this.context.fillText('press `r` to reset the match score.', this.canvas.width / 2, 500);
}
