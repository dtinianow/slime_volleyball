...
Game.prototype.mainMenu = function(keysDown) {
  for (var key in keysDown) {
    var value = Number(key);
    if (value === 78) { this.startNormalMode(); this.player2.slime.ai = false; }
    if (value === 90) { this.startNormalMode(); this.player2.slime.ai = true; }
    if (value === 88) { this.startInsaneMode(); this.player2.slime.ai = true; }
    if (value === 73) { this.startInsaneMode(); this.player2.slime.ai = false;}
