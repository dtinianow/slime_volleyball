...
Game.prototype.mainMenu = function(keysDown) {
  for (var key in keysDown) {
    var value = Number(key);
    if (value == 78) { this.showMenu = false } ;
...
Game.prototype.ballCollision = function(canvas){
  var distanceBetweenBallAndPlayer1 = this.calculateDistance(this.player1);
  var distanceBetweenBallAndPlayer2 = this.calculateDistance(this.player2);

  this.collideWithPlayer(this.player1, distanceBetweenBallAndPlayer1);
  this.collideWithPlayer(this.player2, distanceBetweenBallAndPlayer2);
  this.delayServe();
...
Game.prototype.collideWithPlayer = function(player, distance) {
...
Game.prototype.insanePlayer1GamePoint = function() {
  if (this.scoreboard.player1Score === 6 && this.difficulty === "insane" && this.gameOver === false) {
    this.player1.slime.radius = 20
  }
}

Game.prototype.insanePlayer2GamePoint = function() {
  if (this.scoreboard.player2Score === 6 && this.difficulty === "insane" && this.gameOver === false) {
