...
function Game() {
  ...
  this.player1 = new Player({context: context, canvas: canvas, keysDown: keysDown, ball: this.ball, player: "player 1"}, player1KeyCodes);
  this.player2 = new Player({x: 775, color: 'green', context: context, canvas: canvas, keysDown: keysDown, ball: this.ball, player: "player 2"}, player2KeyCodes);
...
Game.prototype.ballCollision = function(canvas){
  ...
  this.ball.y_speed += .8;
  if(this.player1.slime.y < 600){ this.player1.slime.y += 7.5 }
  if(this.player2.slime.y < 600){ this.player2.slime.y += 7.5 }
