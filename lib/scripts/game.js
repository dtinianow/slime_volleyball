...
Game.prototype.ballCollision = function(canvas){
  ...
  if (this.ball.isTouchingSlime(distance)){
    ...
    console.log("I am touching slime 1")
    console.log(this.ball.x_speed)
    console.log(this.ball.y_speed)
  } else if (this.ball.isTouchingSlime(distance1)) {
    this.ball.bounce(this.player2);
    console.log("I am touching slime 2")
    console.log(this.ball.x_speed)
    console.log(this.ball.y_speed)
  } else if (this.ball.isTouchingWall(canvas)) {
    this.ball.x_speed *= -1.1
    console.log("I am touching the wall")
    console.log(this.ball.x_speed)
    console.log(this.ball.y_speed)
    ...
    console.log(this.ball.x_speed)
    console.log(this.ball.y_speed)
  } else if ((this.ball.x + this.ball.radius >= 535 && this.ball.x - this.ball.radius <= 565) && this.ball.y + this.ball.radius >= this.net.y + this.net.height) {
    console.log("I am touching the net")
    console.log(this.ball.x_speed)
    console.log(this.ball.y_speed)
    this.ball.y_speed *= -1
    this.ball.x_speed *= -1
