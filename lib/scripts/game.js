...
Game.prototype.ballCollision = function(canvas){
  ...
  if (this.ballIsTouchingSlime(distance)){
    this.ball.bounce(this.player1, this.ballSpeed);
  } else if (this.ballIsTouchingSlime(distance1)) {
    this.ball.bounce(this.player2, this.ballSpeed);
...
Game.prototype.ballIsTouchingSlime = function(distance){
  return distance <= this.ball.radius + this.player1.slime.radius;
}
